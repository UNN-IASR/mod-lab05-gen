...
namespace generator
{
    ...
    public class Generator_BIgramm
    {
        ...
        public Generator_BIgramm()
        {
            ...
            string fileContent = File.ReadAllText(@"C:\Users\wizze\source\repos\ProjCharGenerator\ProjCharGenerator\BI.txt");
    ...
    public class Generator_Words_Text
    {
        ...
        public Generator_Words_Text()
        {
            ...
            string freqWordsPath = @"C:\Users\wizze\source\repos\ProjCharGenerator\ProjCharGenerator\frequency_properties_of_words.txt";
