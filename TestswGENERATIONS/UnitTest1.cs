...
//using ProjCharGenerator.generator.Program;
...
namespace ProjCharGenerator.Tests
{
    public class UnitTest1
    {
        ...
        public void Test_2_2()
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(string.Concat(gen1.GenerateNextSymbol(' '))));
        }
        ...
        {
            WordGenerator gW2 = new WordGenerator();
            Assert.AreEqual(gW2.frequentWordsList[1], "�");
        }
    }
